  ...
  <div class="main">
    <div class="nav">
      ...
      <ul>
          ...
          </svg> <a href="gestionMaterial.php">  Gestion Material<a> </li>
    ...
    <div class="mb-3">
        <label for="grupo" class="input_textual">Grupo</label>
    ...
    <div class="mb-3">
        <label for="id" class="form-label">Estudiantes</label>
        <select name="id" id="id">
            <option value="">Selecciona el estudiante</option>
        </select>
        <!-- Campo oculto para almacenar el ID del estudiante seleccionado -->
        <input type="hidden" id="idEstudianteSeleccionado" name="idEstudianteSeleccionado">
    </div>
...
<script>
    document.getElementById('grupo').addEventListener('change', function() {
        ...
        var estudiantesSelect = document.getElementById('id');

        // Eliminar opciones anteriores
        while (estudiantesSelect.firstChild) {
            estudiantesSelect.removeChild(estudiantesSelect.firstChild);
        }

        // Hacer solicitud AJAX para obtener la lista de estudiantes del grupo seleccionado
        var xhr = new XMLHttpRequest();
        xhr.open('GET', 'obtener_estudiantes.php?grupo=' + grupo, true);
        xhr.onload = function() {
            if (xhr.status === 200) {
                ...
                estudiantes.forEach(function(estudiante) {
                    ...
                    option.textContent = estudiante.nombre + ' ' + estudiante.apellidoPaterno + ' ' + estudiante.apellidoMaterno;
    ...
    // Agregar un event listener para actualizar el campo oculto con el ID del estudiante seleccionado
    document.getElementById('id').addEventListener('change', function() {
        var idEstudianteSeleccionado = this.value;
