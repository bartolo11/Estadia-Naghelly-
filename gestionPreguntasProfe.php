   ...
   <body>
      <div class="page">
         ...
         <div class="main">
            ...
            <th scope="col">Opción kinestésica</th>
            <!-- ... (otros títulos) ... -->
            <th scope="col"></th>
            </tr>
            </thead>
            ...
            <!--Se crea un enlace por medio del cual se llama la función modificacionA.php
               ...
               -->
            <a href="modificacionPreProfe.php?id=<?= $datos->idpreguntas ?>" class="btn btn-small btn-warning">
            ...
            <!--Se crea un enlace por medio del cual se llama a sí misma 
               ...
               -->
            <a onclick="return eliminar()" href="gestionPreguntasProfe.php?id=<?= $datos->idpreguntas ?>"  class="btn btn-small btn-danger" >
