<?php
   ...
   $usuario=$_POST['usuario'];   //valor de la correo trasferido por el method post dese el index
   $clave=md5($_POST['clave']);       //valor de la contraseña trasferido por el method post dese el index
   ...
   //consulta la existencia del registro dentro de la tabla profesor
   ...
   //los valores y direcciona al home establecido
       if($datos = $consulta3->fetch_object()){
         ...
         ;
             ...
             //consulta la existencia del registro dentro de la tabla estudiante
       //con los datos del method post
