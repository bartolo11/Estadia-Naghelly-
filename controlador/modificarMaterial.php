<?php
  if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['btnregistrar'])) {
      ...
      //del formulario de modificacionMaterial.php 
      //Datos de la material  
      $id = $_POST["id"];
      ...
      if ($tipo_archivo == 'link'){
          ...
          $sql_updatematerialCompartido=$conexion->query("UPDATE asignar_material SET nombreM = '$enlace' WHERE idMaterial = $id");
              ...
              if ($_POST['opcion'] == 'si' && isset($_FILES['archivo_modificado'])) {
                  ...
                  $sql_updatematerialCompartido=$conexion->query("UPDATE asignar_material SET nombreM = '$nombre_archivo_nuevo' WHERE idMaterial = $id");
                  $resultado = $conexion->query($sql_update);
