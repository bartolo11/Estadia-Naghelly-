<?php
   //función eliminarNovedad.php
   //obtiene un valor del id enviado por el botón 
   //eliminar de la vista gestionNovedades.php o gestionNovedadesAdmin.php y mediante
   ...
   if(!empty($_GET["id"])){
       $id=$_GET["id"];
       $sql=$conexion->query(" delete from novedades where idnovedades=$id");
       if($sql==1){
