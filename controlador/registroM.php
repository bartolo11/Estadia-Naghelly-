...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_FILES["archivo"]) && $_FILES["archivo"]["error"] == 0){
        ...
        if(move_uploaded_file($_FILES["archivo"]["tmp_name"], $directorio_destino . $nombre_archivo)){
            ...
            $query = "INSERT INTO material_didactico (tipo, titulo, descripción, fechaPublicacion, materia_asosiada) VALUES ('$tipo', '$nombre_archivo', '$descripcion', NOW(), '$materia')";
        ...
        $query = "INSERT INTO material_didactico (tipo, titulo, descripción, fechaPublicacion, materia_asosiada) VALUES ('$tipo', '$nombre', '$descripcion', NOW(), '$materia')";
