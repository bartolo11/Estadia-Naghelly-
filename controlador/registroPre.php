   ...
   if(!empty($_POST["btnregistrar"])){
      if(!empty($_POST["pregunta"]) and !empty($_POST["opcionA"]) and !empty($_POST["opcionB"]) and !empty($_POST["opcionC"])){
          ...
          //variables optenidas mediante el method post 
           //del formulario de registroPregunta.php o registroPreguntaProfe.php
           //Datos de paciente 
         $pregunta=$_POST["pregunta"];    //pregunta
         $opcionA=$_POST["opcionA"];     //opcion visual
         $opcionB=$_POST["opcionB"];     //opcion auditiva
         $opcionC=$_POST["opcionC"];     //opcion kinestesica       
         $visual="visual";
         $auditivo="auditivo";
