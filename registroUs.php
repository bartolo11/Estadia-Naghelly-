  ...
  <div class="main">
    <div class="nav">
      ...
      <ul>
          ...
          <li><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-forms" width="23" height="23" viewBox="0 0 24 24" stroke-width="2" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <path d="M17 12h.01" />
            <path d="M13 12h.01" />
          </svg><a href="gestionPreguntas.php"> gestion Test<a></li>
          <li>
        ...
        </svg> <a href="gestionNovedadesAdmin.php"> Gestion Novedades<a></li>
        <li><svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512">
        ...
        </svg><a href="gestionEncuestaA.php"> Gestion Encuesta<a></li>
    ...
    <div class="view">
      ...
      <div class="container-fluid row">
        ...
        <select class="form-control" id="tipo" name="tipo" onchange="toggleGrupo()" required>
            <option disabled selected>Selecciona un tipo de usuario</option>
            <option value="Profesor">Profesor</option>
            <option value="Estudiante">Estudiante</option>
        </select>
        </div>
                <!-- Div adicional para el campo del grupo -->
          <div id="grupoField" class="mb-3" style="display: none;">
          <label for="exampleInputEmail1" class="input_textual">Grupo</label>
...
<script>
  ...
  function toggleGrupo() {
        ...
        var grupoField = document.getElementById("grupoField");

        // Si el tipo de usuario es "Estudiante", muestra el campo del grupo, de lo contrario, ocúltalo
        grupoField.style.display = tipoUsuario === "Estudiante" ? "block" : "none";
    }
</script>
</body>
</html>