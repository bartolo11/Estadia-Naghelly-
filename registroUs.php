         ...
         <div class="view">
            <div class="container-fluid row">
               ...
               <form  class=" col-10 p-3 formulario" method="POST" onsubmit="return validarContrasena();" >
                  ...
                  <div class="mb-3">
                     <label for="exampleInputEmail1" class="input_textual">Género</label>
                  ...
                  <div class="mb-3">
                     <label for="exampleInputEmail1" class="input_textual">Correo Electrónico</label>
                     <!--Genera el espacio para introducir el apellido materno del administrador y envía 
                        el dato apellidoM por medio del method post del formulario -->
                  ...
                  <div class="mb-3">
                     ...
                     <select class="form-select" id="tipo" name="tipo" onchange="toggleGrupo()" required>
