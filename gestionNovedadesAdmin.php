<?php 
  ...
  include "controlador/eliminarNovedad.php";
...
while ($fila = mysqli_fetch_assoc($resultado)) {
  $nombre = $fila['idnovedades'];
    echo '<tr>';
    echo '<td>' . $fila['idnovedades'] . '</td>';
    echo '<td>' . $fila['tituloNov'] . '</td>';
    echo '<td>' . $fila['descripciónNov'] . '</td>';
    echo '<td>' . $fila['fechaPub'] . '</td>'; // Tipo de archivo
    ...
    ?>
      <td>
            <!--Se crea un enlace por medio del cual se llama la función modificacionA.php
              ...
              -->
            <a href="modificacionNovedadAdmin.php?id=<?= $nombre ?>" class="btn btn-small btn-warning">
    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-edit-circle" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <path d="M9 7.07a7.002 7.002 0 0 0 1 13.93a7.002 7.002 0 0 0 6.929 -5.999" />
            ...
            <!--Se crea un enlace por medio del cual se llama a sí misma 
              ...
              -->
            <a onclick="return eliminar()" href="gestionNovedadesAdmin.php?id=<?= $nombre ?>"  class="btn btn-small btn-danger" >
