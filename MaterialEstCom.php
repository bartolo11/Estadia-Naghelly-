<?php
   ...
   include "controlador/estadoMaterialDoc.php";
      ...
      <div class="page">
         ...
         <div class="main">
               ...
               <div class="menu">
                  ...
                  <ul>
                     ...
                     <li>
                        ...
                        <a href="encuesta.php"> Encuesta de Satisfación
                        <a>
                     </li>
            ...
            <?php
               ...
               // Consulta para obtener los materiales asignados al estudiante
            ...
            <?php
               while ($fila = mysqli_fetch_assoc($resultado)) {
                   ...
                   $idNotificacion=$fila['idMaterial'];
               
                   // Consulta para obtener las notificaciones correspondientes al material actual
                   
               
                   // Iterar sobre las notificaciones y mostrar los botones
                   
                       ?>
            <td>
            <a href="MaterialEstCom.php?id=<?= $idNotificacion ?>" class="btn btn-small btn btn-primary">
