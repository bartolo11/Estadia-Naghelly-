  ...
  <body>
    <div id="wrapper">
      ...
      <!--Se genera un espacio de para un menú de navegación
        mediante el cual se crean los enlaces a cada página
		de cada función
        -->
      <nav>
        <br>
        <h2>Menu</h2>
        <ul class="menu">
          <li><a href="gestionA.php">Gestión de Administradores</a></li>
          <li><a href="gestionD.php">Gestión de Doctores</a></li>
          ...
          <li><a href="controlador/reporteMedico.php">Generar Reporte médico</a></li>
          <li><a href="historialm.php">Generar Historial médico</a></li>
          <li><a href="controlador/nani.php">Generar respaldo de base de datos</a></li>
          <li><a href="respaldo">Restauración de la base de datos <a></li>
