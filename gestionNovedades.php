      ...
      <div class="page">
         ...
         <div class="main">
            <div class="nav">
               <div class="menu">
                  ...
                  <ul>
                     ...
                     <path d="M17 12h.01" />
                     <path d="M13 12h.01" />
                     </svg><a href="gestionPreguntasProfe.php"> Gestión Preguntas<a></li>
                     <li>
                     ...
                     </svg> <a href="gestionMaterialProfe.php">  Gestión Material<a> </li>
                     <li><svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512">
                     ...
                     </svg> <a href="gestionNovedades.php"> Gestión Novedades<a></li>
            ...
            <!--Se crea un enlace por medio del cual se llama la función modificacionA.php
               ...
               -->
            <a href="modificacionNovedad.php?id=<?= $nombre ?>" class="btn btn-small btn-warning">
            ...
            <!--Se crea un enlace por medio del cual se llama a sí misma 
               ...
               -->
            <a onclick="return eliminar()" href="gestionNovedades.php?id=<?= $nombre ?>"  class="btn btn-small btn-danger" >
