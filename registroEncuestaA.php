   ...
   <body>
      ...
      <div class="pageHeader">
         ...
         <div class="userPanel"><span class="username" style="color:#000000";><i class="fa-solid fa-user-large"></i>
            <?php   echo  $_SESSION["nombre"]; //imprime el nombre del usuario que inicio sesión 
               ?></span>
         </div>
      </div>
      <div class="main">
         ...
         <div class="view">
            <div class="container-fluid row">
               ...
               <form  class=" col-10 p-3 formulario" method="POST"  >
                  <h3>Registro Pregunta Encuesta</h3>
                  <hr    color="#000000";>
                  <?php
                     include "modelo/conexion.php";
                     include "controlador/registroEncuesta.php";
                     ?>
                  <!--Se genera la llamada a la función registroEncuesta.php la cual genera el registro de la pregunta por medio
                     ...
                     -->
                  <div class="mb-3">
                     <!--Genera el espacio para introducir el titulo de la pregunta y envía el dato titulo
