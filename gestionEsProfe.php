      ...
      <div class="page">
         ...
         <div class="main">
            ...
            <!--Se crea un enlace por medio del cual se llama la función modificacionA.php
               ...
               -->
            <a href="modificacionEProfe.php?id=<?= $datos->idEstudiante ?>" class="btn btn-small btn-warning">
            ...
            <!--Se crea un enlace por medio del cual se llama a sí misma 
               ...
               -->
            <a onclick="return eliminar()" href="gestionEsProfe.php?id=<?= $datos->idEstudiante ?>"  class="btn btn-small btn-danger" >
