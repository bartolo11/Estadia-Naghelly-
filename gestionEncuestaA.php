<?php 
   ...
   // Valida que el usuario haya iniciado sesión correspondiente con el tipo de usuario correspondiente a esta vista
...
<html lang="en">
   ...
   <body>
      <div class="page">
         ...
         <div class="main">
            <div class="nav">   <!--Menú de navegación con las redirecciones correspondientes a la sesión utilizada  -->
               <div class="menu">
                  <div class="title">
                     <center>Menu</center>
                  </div>
            ...
            <h3>Gestión Encuesta</h3>
            <hr    color="#000000";>
            </form>
            <?php
               include "modelo/conexion.php";
               
               // consulta sql para obtener todos los datos de los registros en la tabla encuesta en nuestra base de datos 
            ...
            <?php
               // por medio de este while recorrerá todos los registros en la tabla encuesta y obtendrá cada uno de los datos 
               // para imprimirlos en la tabla
               while ($fila = mysqli_fetch_assoc($resultado)) {
                 $nombre = $fila['idEncuesta'];
                   ...
                   ?>
            <td>
            <!--Se crea un enlace por medio del cual se llama la función modificacionEncuesta.php
            ...
            <td>
            <!--Se crea un enlace por medio del cual envía el id de la pregunta de la encuesta 
            y que este genere la vista necesaria
             -->
      ...
      <script>
         // Función para validar la elinimación
         function eliminar()
             {
