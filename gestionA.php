...
<html lang="en">
  ...
  <body style="background: linear-gradient(to right, #cebbf5,#b460d5);">
    ...
    <!--Se genera la llamada a la función eliminarA.php la cual genera la eliminación de Administradores por medio
      de un dato de control el cual es la id del administrador que se registra si es que se selecciona la opción
    ...
    <?php
      ...
      ?>
    <!--Genera el espacio para desarrollar un formulario en el que se colocarán distintos espacios para poder
      llevar a cabo el registro de los datos con los cuales se trabajan
       -->       
    <div class="container-fluid row">
      ...
      <form class="col-4 p-3" method="POST">
        ...
        <?php
          ...
          ?>
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">Nombre del Administrador</label>
        ...
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">Apellido paterno del Administrador</label>
        ...
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">Apellido materno del Administrador</label>
        ...
        <table class="table">
          ...
          <tbody class="table bg-light text-dark  table-striped table-bordered border-dark">
            ...
            <tr>
              <td><?= $datos->idAdmin ?></td>
              <td><?= $datos->NombreA ?></td>
              <td><?= $datos->ApellidoPA ?></td>
              <td><?= $datos->ApellidoMA ?></td>
              <td><?= $datos->FeNacA ?></td>
              <td><?= $datos->CedulaA ?></td>
              <td><?= $datos->contraseñaA ?></td>
              <td>
                <!--Se crea un enlace por medio del cual se llama la función modificacionA.php
                  ...
                  -->
                <a href="modificacionA.php?id=<?= $datos->idAdministrador ?>" class="btn btn-small btn-warning">
                ...
                <!--Se crea un enlace por medio del cual se llama a sí misma 
                  ...
                  -->
                <a onclick="return eliminar()" href="gestionA.php?id=<?= $datos->idAdmin ?>"  class="btn btn-small btn-danger" >
